...
//	}
	...
	public List selectMap(Map paginMap) throws DataAccessException{
		List<ArticleVO> articlesList = articlesList = sqlSession.selectList("mapper.board.selectMap",paginMap);
		return articlesList; 
	...
	public int select() throws DataAccessException{
		return sqlSession.selectOne("mapper.board.selectcount");
	}
	//조회수에 대한 쿼리를 dao에 구현
	@Override
	public void updateCount(int articleNO) throws DataAccessException{
		sqlSession.update("mapper.board.count",articleNO);
	}
	@Override
